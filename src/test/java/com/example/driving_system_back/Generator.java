...
public class Generator {
    // 数据库连接字段配置
    private static final String JDBC_URL = "jdbc:mysql://yeh-wang.rwlb.cn-chengdu.rds.aliyuncs.com:3307/drive_system?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "123456&wYx";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.example.driving_system_back";

    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"blank_topic","examination","multiple_choice","examination_and_blank_topic","examination_and_multiple_choice"};
